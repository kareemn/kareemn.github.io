...
function drawing(slug) {
  switch (slug) {
    ...
    case 'habits': return map(668,231,1.5) + text(895,197,'PERSISTENCE',16,'#aab8c6','text-anchor="middle" letter-spacing="2"') + text(751,479,'TOOL USE',16,'#aab8c6','text-anchor="middle" letter-spacing="2"') + text(1034,479,'COLLABORATION',16,'#aab8c6','text-anchor="middle" letter-spacing="2"');
